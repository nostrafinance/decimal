...
describe('DecimalFormat', () => {
  describe('Multiplier format', () => {
    const cases: {
      ...
      { value: 100000000, fractionDigits: 1, expected: '100.0M' },
      { value: 299792458, fractionDigits: 1, expected: '299.7M' },
      { value: 759878, fractionDigits: 1, expected: '759.8k' },
      { value: 759878, fractionDigits: 0, expected: '759k' },
      ...
      { value: '7389', fractionDigits: 1, expected: '7.3k' },
      { value: '-7389', fractionDigits: 1, expected: '-7.3k' },
      { value: '63427184', fractionDigits: 0, expected: '63M' },
      { value: '63427184', fractionDigits: 2, expected: '63.42M' },
      { value: '-63427184', fractionDigits: 0, expected: '-63M' },
      { value: '-63427184', fractionDigits: 2, expected: '-63.42M' },
      { value: '999999', fractionDigits: 1, expected: '999.9k' },
      ...
      { value: '7389', expected: '7k' },
      { value: '7389', fractionDigits: 1, noMultiplierFractionDigits: 3, expected: '7.3k' },
      { value: '-7389', fractionDigits: 1, noMultiplierFractionDigits: 1, expected: '-7.3k' },
      { value: '63427184', fractionDigits: 0, expected: '63M' },
      { value: '63427184', fractionDigits: 2, noMultiplierFractionDigits: 1, currency: 'ETH', expected: '63.42M ETH' },
      { value: '-63427184', fractionDigits: 0, noMultiplierFractionDigits: 3, expected: '-63M' },
      { value: '-63427184', fractionDigits: 2, noMultiplierFractionDigits: 5, expected: '-63.42M' },
      ...
      { value: '7389', fractionDigits: 1, approximate: true, expected: '~7.3k' },
      { value: '-7389', fractionDigits: 1, approximate: true, expected: '~-7.3k' },
      { value: '63427184', fractionDigits: 0, approximate: true, expected: '~63M' },
      { value: '63427184', fractionDigits: 2, approximate: true, expected: '~63.42M' },
      { value: '-63427184', fractionDigits: 0, approximate: true, expected: '~-63M' },
      { value: '-63427184', fractionDigits: 2, approximate: true, expected: '~-63.42M' },
    ];
